...
starbucks <- ovun.sample(completed ~ age + gender + income + reward + id+ difficulty + weeks_as_member + offer_type + channels, data = starbucks_train, method = "both", N = 112000, seed =1)$data
